...
string shift(string conv, int num)
{
    string res = "";
    for (int i = 0; i < num; i++)
    {
...
string permute2(string combine, int arr[], int size)
{
    string res = "";
...
string xoor(string v, string op)
{
    string t = "";
...
string encrypt(string pt, vector<string> rkb, vector<string> rk)
{
    ...
    pt = permute2(pt, initial_perm, 64);
    ...
    for (int i = 0; i < 16; i++)
    {
        string right_expanded = permute2(right, exp_d, 48);
        string x = xoor(rkb[i], right_expanded);
    ...
    //Final Permutation
    string cipher = bin2hex(permute2(combine, final_perm, 64));
    return cipher;
}
int main()
{
    ...
    for (int i = 0; i < 16; i++)
    {
        ...
        //combining
        string combine = left + right;
        string roundkey = permute2(combine, key_comp, 48);
